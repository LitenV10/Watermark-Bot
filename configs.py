...
class Config(object):
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6429225705:AAGaoz2jvBvJJgbyngSHZkqlluDzk-eU37M")
	...
	LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL","-1002060387811"))
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", None)
	DOWN_PATH = os.environ.get("DOWN_PATH", "./downloads")
	PRESET = os.environ.get("PRESET", "ultrafast")
	OWNER_ID = int(os.environ.get("OWNER_ID", 5196029054))
	CAPTION = "By @LitenV10"
	BOT_USERNAME = os.environ.get("BOT_USERNAME", "watermarklitenbot")
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://Liten:OoIj9FZ6J5ca7K31@cluster0.hcxotkc.mongodb.net/?retryWrites=true&w=majority")
